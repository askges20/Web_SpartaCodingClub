...
def api_login():
    ...
    if result is not None:
        ...
        # id와 exp를 담음 (즉, JWT 토큰을 풀면 유저ID 값을 알 수 있다)
        # exp는 만료시간. 만료시간이 지나면 시크릿키로 토큰을 풀 때 만료되었다고 에러 발생
        payload = {
            'id': id_receive,
